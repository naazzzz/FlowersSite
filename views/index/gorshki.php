                ...
                <table>
                    ...
                    <?php foreach ($flowersInfo as $oneflower):  ?>
                        <td class="price"><img src = "<?=$oneflower['img'];?>">
                            ...
                            <button onclick="document.location='index.php?route=product&id=<?=$oneflower['id'];?>&table=gorshki'" class="custom-btn first-button cst-btn">Подробнее</button>
                        </td>
                    <?php endforeach; ?>
                </tbody>
                </table>
